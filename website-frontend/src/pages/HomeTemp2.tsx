...
export default function HomeTemp2() {
    // Media States
    ...
    return (
        <div 
            ...
            style={{
                '--color-primary': '#4A542B',      // Moss Shadow (Green base)
                '--color-secondary': '#C2441C',    // Burnt Nectar
                '--color-accent': '#0D244D',       // Indigo Rain
                '--color-bg': '#ffffff',           // White background
                '--color-background': '#ffffff',
                '--color-surface': '#f5f6f8',      // Very light surface
                '--color-text': '#0D244D',         // Indigo Rain
                '--color-text-dim': '#4A542B',     // Moss Shadow
                '--color-border': 'color-mix(in srgb, #0D244D 15%, transparent)',
                '--color-panel': 'color-mix(in srgb, #0D244D 5%, transparent)',
