...
export default function HomeAlt() {
    ...
    const altTheme = {
        '--color-bg': '#fcfcfc', // White
        '--color-primary': '#ea580c', // Orange
        '--color-secondary': '#1e3a8a', // Navy blue
        '--color-text': '#0f172a', // Dark Navy Text
        '--color-surface': '#ffffff', // White
        '--color-panel': '#fff7ed', // Warm Cream
        '--color-border': '#fed7aa', // Light Orange
    } as React.CSSProperties;

    return (
        <div style={altTheme} className="bg-[var(--color-bg)] text-[var(--color-text)] overflow-x-hidden">
            <Header />
            ...
            {/* Philosophy Section */}
            <section id="philosophy" className="py-24 px-6 bg-[var(--color-secondary)]">
                <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                    ...
                    >
                        ...
                        <h2 className="font-serif text-4xl md:text-5xl font-black mb-8 text-[var(--color-surface)]">Food Made With <span className="text-[var(--color-primary)]">Love & Purity</span></h2>
                        
                        <p className="text-lg text-[var(--color-surface)]/80 leading-relaxed mb-6">
                        ...
                        <p className="text-lg text-[var(--color-surface)]/80 leading-relaxed">
                    ...
                    <motion.div
                        ...
                        className="bg-[var(--color-surface)] rounded-[2rem] border border-[var(--color-border)] shadow-2xl overflow-hidden"
                    >
                        <div className="p-8 pb-6">
                            ...
                            <div className="w-12 h-[2px] bg-[var(--color-primary)] mx-auto mb-4"></div>
            ...
            {/* About Us Section */}
            <section id="about-us" className="py-24 px-6 bg-[var(--color-panel)] text-[var(--color-text)]">
                <div className="max-w-4xl mx-auto">
                    ...
                    >
                        <motion.div variants={fadeUpVariant}>
                            ...
                            <div className="bg-[var(--color-surface)] p-10 md:p-14 rounded-[2.5rem] shadow-2xl border border-[var(--color-border)]">
                                <h3 className="text-4xl text-[var(--color-text)] mb-6 font-serif font-black">Food!!!!!</h3>
                                <p className="text-xl md:text-2xl text-[var(--color-text)]/80 leading-relaxed mb-8">
            ...
            <section className="py-32 px-6 bg-[var(--color-secondary)] text-center relative overflow-hidden">
                ...
                >
                    <motion.div variants={scaleVariant} className="text-4xl md:text-5xl mb-6 text-[var(--color-surface)] font-serif font-bold">
                        अहं वैश्वानरो भूत्वा प्राणिनां देहमाश्रितः।
                    </motion.div>
                    <motion.div variants={scaleVariant} className="text-xl md:text-2xl text-[var(--color-surface)]/80 italic font-medium">
                        "The Divine digests food in four ways within living beings." <br /> — Bhagavad Gita (15.14)
                    </motion.div>
                    <motion.p variants={flyInRightVariant} className="mt-10 text-lg md:text-xl text-[var(--color-surface)]/90 max-w-2xl mx-auto leading-relaxed">
            ...
            <section id="our-nature" className="py-24 bg-[var(--color-secondary)] overflow-hidden">
                <motion.h2
                    initial="hidden"
                    whileInView="visible"
                    viewport={{ once: true }}
                    ...
                    >
                        ...
                        {[1, 2, 3].map((set) => (
                            <React.Fragment key={set}>
                                <div className="w-[320px] bg-[var(--color-surface)] border border-[var(--color-border)] p-8 rounded-3xl shrink-0 hover:border-[var(--color-primary)] transition-colors">
                                    <Sprout size={48} className="text-[var(--color-primary)] mb-6" />
                                    <h3 className="text-2xl font-black mb-4 text-[var(--color-text)]">Unpolished Grains</h3>
                                    <p className="text-[var(--color-text)]/70 leading-relaxed">Polishing strips away vital nutrients. Our millets retain their bran layer, providing maximum dietary fiber and slow-release energy.</p>
                                </div>
                                <div className="w-[320px] bg-[var(--color-panel)] border border-[var(--color-border)] p-8 rounded-3xl shrink-0 hover:border-[var(--color-primary)] transition-colors shadow-lg">
                                    ...
                                    <p className="text-[var(--color-text)]/70 leading-relaxed">We believe sweetness should come from nature, not factories. We use only pure, unrefined jaggery and raw honey.</p>
                                </div>
                                <div className="w-[320px] bg-[var(--color-surface)] border border-[var(--color-border)] p-8 rounded-3xl shrink-0 hover:border-[var(--color-primary)] transition-colors">
                                    ...
                                    <p className="text-[var(--color-text)]/70 leading-relaxed">We trace every ingredient back to the earth. By working directly with village farmers, we ensure fair trade and untampered crop quality.</p>
                                </div>
                                <div className="w-[320px] bg-[var(--color-panel)] border border-[var(--color-border)] p-8 rounded-3xl shrink-0 hover:border-[var(--color-primary)] transition-colors shadow-lg">
                                    <Droplet size={48} className="text-[var(--color-secondary)] mb-6" />
                                    <h3 className="text-2xl font-black mb-4 text-[var(--color-text)]">Honest Processing</h3>
                                    <p className="text-[var(--color-text)]/70 leading-relaxed">From wooden-churned (Chekku) cold-pressed oils to stone-ground flours, we preserve delicate antioxidants heat would destroy.</p>
                                </div>
                                <div className="w-[320px] bg-[var(--color-surface)] border border-[var(--color-border)] p-8 rounded-3xl shrink-0 hover:border-[var(--color-primary)] transition-colors">
                                    ...
                                    <p className="text-[var(--color-text)]/70 leading-relaxed">Food is spiritual fuel. Every recipe is meticulously tested to ensure it brings balance, health, and clean energy to your family.</p>
                                </div>
                            </React.Fragment>
                        ))}
                    </motion.div>
